...
struct _GdvSpecialDrumDisplayPrivate
{
...
G_DEFINE_TYPE_WITH_PRIVATE (
  ...
  gdv_special_drum_display,
  GDV_ONED_LAYER_TYPE)

static GParamSpec *drum_display_properties[N_PROPERTIES] = { NULL, };


static void
gdv_special_drum_display_set_property (
  GObject      *object,
  guint         property_id,
  const GValue *value,
  GParamSpec   *pspec)
...
static void
gdv_special_drum_display_get_property (
  GObject    *object,
  guint       property_id,
  GValue     *value,
  GParamSpec *pspec)
...
gdv_special_drum_display_class_init (GdvSpecialDrumDisplayClass *klass)
{
  ...
  object_class->get_property = gdv_special_drum_display_get_property;

  /**
   * GdvSpecialDrumDisplay:center-value:
   *
  ...
  /**
   * GdvSpecialDrumDisplay:left-right-range:
   *
  ...
  g_object_class_install_properties (object_class,
                                     N_PROPERTIES,
                                     drum_display_properties);
}

static void refresh_values (GdvSpecialDrumDisplay *display)
{
  GdvAxis *axis;
...
static void
gdv_special_drum_display_init (GdvSpecialDrumDisplay *display)
{
  GdvAxis *axis;
